...
const About = () => {
  return (
    <>
      ...
      <main>
        <Hero preHeading={'Quality. Integrity. Value.'} heading={'About Us'} text={' We excel at transforming visions into reality through outstanding craftsmanship and precise <br /> attention to detail. With years of experience and a dedication to quality.'} />
